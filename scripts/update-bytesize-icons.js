...
const outputName = join(__dirname, `../public/assets/${scriptName}.js`)
const minifiedName = join(__dirname, `../public/assets/${scriptName}.min.js`)
const sourceMapName = join(__dirname, `../public/assets/${scriptName}.min.js.map`)
...
console.log(`Writing "${scriptName}.js", "${scriptName}.min.js" and "${scriptName}.min.js.map" to "public/assets"...`)
